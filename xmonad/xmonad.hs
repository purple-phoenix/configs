...
--
myTerminal      = "~/github/alacritty/target/release/alacritty"
...
myWorkspaces    = ["1|JIRA","2|Comm","3|Vi","4|VMs","5|Browsing",
                   "6|Misc","7|Remmina","8|TeamViewer","9|Zoom"]
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Start chrome
    , ((modm              , xK_f     ), safeSpawnProg "google-chrome")
    ]
    ++
...
--
myLayout = avoidStruts( tiled ||| Mirror tiled ||| Full ||| ThreeCol nmaster delta ratio)
  where
...
--
myLogHook xmproc =  dynamicLogWithPP xmobarPP { ppOutput = hPutStrLn xmproc, ppTitle = xmobarColor "green" "" . shorten 50}
